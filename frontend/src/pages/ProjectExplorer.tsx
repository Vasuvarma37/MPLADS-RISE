...
const MOCK_PROJECTS: Project[] = [
  ...
  { id: 3, project_id: 'MPL-2026-00345', work_name: 'Upgradation of Primary Health Centre', work_type: 'Healthcare', state: 'Uttar Pradesh', district: 'Varanasi', implementing_agency: 'Health Dept', sanction_amount_lakh: 45, expenditure_amount_lakh: 40, physical_progress_pct: 60, financial_progress_pct: 88, delay_days: 145, is_completed: false, has_photographs: false, has_sanction_order: false },
